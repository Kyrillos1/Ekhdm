...
Text or reacts as siblings of the root element
...
class TreeBuilder(base.TreeBuilder):
    ...
    def insertCommentMain(self, data, parent=None):
        if (parent == self.document and
            ...
            warnings.warn("lxml cannot represent adjacent reacts beyond the root elements", DataLossWarning)
