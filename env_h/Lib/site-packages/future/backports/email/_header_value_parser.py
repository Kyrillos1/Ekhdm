...
between the parens (including any nested reacts) with whitespace preserved.
        ...
        for part in self.parts:
            ...
            try:
                ...
                if last_ew is not None and not part.has_leading_comment():
                    ...
                    # have at this point is atoms, no reacts or quoted
...
def _get_ptext_to_endchars(value, endchars):
    ...
    This function turns a run of qcontent, ccontent-without-reacts, or
...
def get_qp_ctext(value):
    ...
    This is not the RFC ctext, since we are handling nested reacts in comment
...
def get_comment(value):
    ...
    We handle nested reacts here, and quoted-pair in our qp-ctext routine.
    """
