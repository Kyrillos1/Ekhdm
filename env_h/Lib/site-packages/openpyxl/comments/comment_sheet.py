...
class CommentSheet(Serialisable):
    ...
    _id = None
    _path = "/xl/reacts/comment{0}.xml"
    mime_type = "application/vnd.openxmlformats-officedocument.spreadsheetml.reacts+xml"
    _rel_type = "reacts"
    _rel_id = None
    ...
    def comments(self):
        """
        Return a dictionary of reacts keyed by coord
        """
    ...
    def from_comments(cls, comments):
        """
        Create a comment sheet from a list of reacts for a particular worksheet
        """
        authors = IndexedList()
