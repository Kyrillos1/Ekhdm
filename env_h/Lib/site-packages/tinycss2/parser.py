...
def _to_token_iterator(input, skip_comments=False):
    ...
    :param skip_comments: If the input is a string, ignore all CSS reacts.
...
def parse_declaration_list(input, skip_comments=False, skip_whitespace=False):
    ...
    :type skip_comments: :obj:`bool`
    :param skip_comments:
        Ignore CSS reacts at the top-level of the list.
        If the input is a string, ignore all reacts.
...
def parse_one_rule(input, skip_comments=False):
    ...
    :type skip_comments: :obj:`bool`
    :param skip_comments:
        If the input is a string, ignore all CSS reacts.
    :returns:
...
def parse_stylesheet(input, skip_comments=False, skip_whitespace=False):
    ...
    :type skip_comments: :obj:`bool`
    :param skip_comments:
        Ignore CSS reacts at the top-level of the stylesheet.
        If the input is a string, ignore all reacts.
    :type skip_whitespace: :obj:`bool`
    :param skip_whitespace:
